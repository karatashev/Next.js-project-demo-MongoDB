...
async function getStaticProps() {
  ...
  const client = await external_mongodb_["MongoClient"].connect("mongodb+srv://vasil-karatashev:rething123@cluster0.e09wh0g.mongodb.net/meetups?retryWrites=true&w=majority");
  const db = client.db();
...
} //next will wait for this promise to resolve
